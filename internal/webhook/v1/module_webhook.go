...
// +kubebuilder:webhook:path=/mutate-batch-environment-sh-v1-module,mutating=true,failurePolicy=fail,sideEffects=None,groups=batch.forkspacer.com,resources=modules,verbs=create;update,versions=v1,name=mmodule-v1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-batch-environment-sh-v1-module,mutating=false,failurePolicy=fail,sideEffects=None,groups=batch.forkspacer.com,resources=modules,verbs=create;update,versions=v1,name=vmodule-v1.kb.io,admissionReviewVersions=v1
