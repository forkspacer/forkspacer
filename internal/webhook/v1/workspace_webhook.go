...
// +kubebuilder:webhook:path=/mutate-batch-environment-sh-v1-workspace,mutating=true,failurePolicy=fail,sideEffects=None,groups=batch.environment.sh,resources=workspaces,verbs=create;update,versions=v1,name=mworkspace-v1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-batch-environment-sh-v1-workspace,mutating=false,failurePolicy=fail,sideEffects=None,groups=batch.environment.sh,resources=workspaces,verbs=create;update,versions=v1,name=vworkspace-v1.kb.io,admissionReviewVersions=v1
...
func (v *WorkspaceCustomValidator) ValidateCreate(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	...
	if len(allErrs) > 0 {
		return nil, apierrors.NewInvalid(
			schema.GroupKind{Group: "batch.environment.sh", Kind: "Workspace"},
